"""Cursor Agent session adapter (placeholder)."""
...
@register
class CursorAgentAdapter(SessionAdapter):
    """Placeholder adapter for Cursor Agent sessions.

    Cursor Agent is not yet supported. This adapter exists as a
